...
namespace Sample.Web.Core.Extensions.Selenium
{
    ...
    public static class WaitExtensions
    {
        ...
        {
            return driver.WaitFor(_ => element.Text.Equals(expectedText), exceptionTypes: new[] { typeof(NoSuchElementException), typeof(NullReferenceException), typeof(StaleElementReferenceException) });
        }
        ...
        public static bool WaitForElementDisappeared(this IWebDriver driver, By locator, int timeout = MediumTimeout, string message = null)
        {
            var isDisplay = true;
            while (isDisplay)
            {
        ...
        {
            return driver.Wait(timeoutInSec).Until(_ => driver.JsExecutor().ExecuteScript("return document.readyState").Equals("complete"));
        }
        ...
        public static IWebElement WaitElementIsVisible(this IWebDriver driver, By locator, int timeoutInSec) => Wait(driver, timeoutInSec).Until(ExpectedConditions.ElementIsVisible(locator));
        ...
        private static WebDriverWait Wait(this IWebDriver driver, int timeout = MediumTimeout, string message = null) => new(driver, TimeSpan.FromSeconds(timeout)) { Message = message };
    }
}