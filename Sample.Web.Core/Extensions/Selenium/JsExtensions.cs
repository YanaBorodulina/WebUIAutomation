...
namespace Sample.Web.Core.Extensions.Selenium
{
    ...
    {
        private const double _sleep = 0.5;
        ...
        {
            element.ToDriver().ExecuteScript($"arguments[0].style.border='{frameSize}px {style} {cssColor}'", element);
        ...
        {
            element.ToDriver().ExecuteScript("arguments[0].style.border='0px solid white'", element);
        }
        ...
        public static IWebElement JsFocus(this IWebElement element)
        {
            ...
            element.ToDriver().ExecuteScript(scrollElementIntoMiddle, element);
        ...
        public static void JsClick(this IWebElement element, bool highlight = true)
        {
            ...
            element.ToDriver().ExecuteScript("arguments[0].click();", element);
        }
        ...
        public static void JsMouseOver(this IWebElement element)
        {
            ...
            element.ToDriver().ExecuteScript(mouseOverScript, element);
        }
        ...
        {
            var isLoaded = false;
            var result = image.ToDriver().ExecuteScript(
        ...
        {
            var arttributesObject = element.ToDriver().ExecuteScript(
                "var items = {}; " +
