...
namespace Sample.Web.Core.Extensions.Selenium
{
    public static class WebElementExtensions
    {
        ...
        {
            if (context is IWrapsDriver iWrappedElement)
            {
        ...
        public static bool HasAttribute(this IWebElement e, string attributeName) => !e.GetAttribute(attributeName).Equals(string.Empty);
        ...
        public static string TextClear(this IWebElement element) => element.Text.Trim('\r', '\n');
        ...
        public static IWebElement GetParent(this IWebElement element) => element.FindElement(By.XPath("./parent::*"));

        public static IWebElement GetChild(this IWebElement element) => element.FindElement(By.XPath("./child::*"));
        ...
        public static By GetBy(this IWebElement element) => By.XPath(GetXPathAsString(element));
        ...
        public static string GetXPathAsString(this IWebElement element)
        {
            ...
            foreach (var el in element.JsGetAttributes())
            {
                ...
                if (!el.Equals(attributesDict.Last()))
                {
                    sb.Append(" and ");
                }
            }
